 ...
 Alexandre Jaborska - <a href="mailto:jaborska.alexandre@chu-amiens.fr">jaborska.alexandre@chu-amiens.fr</a></span></p>"""
        ...
        'external-links': {
            ...
            'intranet': {
                ...
                'help_text': _("Accès (dans un nouvel onglet) à l'intranet du CHU Amiens-Picardie"),
            ...
            'annuaire': {
                'icon': None,
                'label': _("Annuaire"),
                'help_text': _("Accès (dans un nouvel onglet) à l'annuaire du CHU Amiens-Picardie"),
            ...
            'asset-web': {
                'icon': None,
                'label': _("Asset+ WEB"),
                'help_text': _("Accès (dans un nouvel onglet) à la GMAO Asset Plus Web"),
